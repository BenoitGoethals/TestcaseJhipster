package be.mil.repository;

import be.mil.TestcaseJhipsterApp;
import be.mil.config.Constants;
import be.mil.config.audit.AuditEventConverter;
import be.mil.domain.PersistentAuditEvent;
...
import static be.mil.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
