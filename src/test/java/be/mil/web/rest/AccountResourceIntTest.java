package be.mil.web.rest;

import be.mil.config.Constants;
import be.mil.TestcaseJhipsterApp;
import be.mil.domain.Authority;
import be.mil.domain.User;
import be.mil.repository.AuthorityRepository;
import be.mil.repository.UserRepository;
import be.mil.security.AuthoritiesConstants;
import be.mil.service.MailService;
import be.mil.service.dto.UserDTO;
import be.mil.web.rest.errors.ExceptionTranslator;
import be.mil.web.rest.vm.KeyAndPasswordVM;
import be.mil.web.rest.vm.ManagedUserVM;
import be.mil.service.UserService;
...
@SpringBootTest(classes = TestcaseJhipsterApp.class)
